...
const Footer = () => {
  return (
    <footer className="flex pt-4 xl:mt-20 bottom-0  sticky  p-2 bg-[#191919]  w-full  border-t-gray-400 border-t border-solid ">
      <div className="flex-col  px-6 w-full justify-start items-start">
        <div className="flex justify-between w-full ">
          ...
          <div className="text-blue-500 text-4xl font-bold ">84</div>
        </div>
